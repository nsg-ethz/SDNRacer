...
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi-StarTopology2-steps200/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi-StarTopology2-steps400/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi-StarTopology2-steps600/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi-StarTopology2-steps800/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi_fixed-StarTopology2-steps200/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi_fixed-StarTopology2-steps400/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi_fixed-StarTopology2-steps600/hb.json &&
./sts/happensbefore/reduce/reduce.py results/pox_eel_l2_multi_fixed-StarTopology2-steps800/hb.json &&
