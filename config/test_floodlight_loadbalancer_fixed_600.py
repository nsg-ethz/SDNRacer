...
controllers = [ControllerConfig(start_cmd, cwd='../floodlight_fixed', address="127.0.0.1", port=6633)]
...
steps = 600
results_dir = "results/floodlight_loadbalancer_fixed-%s%d-steps%s" % (topology_class.__name__, num, steps)
